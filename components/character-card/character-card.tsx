...
export function CharacterCard({
  ...
  const { goToCharacterEditPage } = useCharacterNavigation()
      ...
      >
        <figure className='absolute translate-y-[1rem] select-none pointer-events-none'>
          <Image
            ...
            height={500}
            alt={`Personaje: ${name}`}
            className='h-full w-full object-cover transition-all duration-300 ease-in-out group-hover/item:scale-110 group-hover/item:grayscale-0 '
          />
        </figure>
          ...
          <div className='absolute bottom-3 right-3 select-none flex items-center'>
            <figure className='select-none pointer-events-none size-12'>
              <Image
                ...
                className='h-full w-full object-cover transition-all duration-300 ease-in-out opacity-0 scale-0 group-hover/item:opacity-100 group-hover/item:scale-110'
              />
            </figure>
