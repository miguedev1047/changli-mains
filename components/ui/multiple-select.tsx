...
export const MultipleSelect = ({
  ...
  ...props
}: React.ComponentProps<typeof Command> & MultipleSelectorProps) => {
  ...
  React.useImperativeHandle(
    props.ref as React.ForwardedRef<MultipleSelectorRef>,
    () => ({
  ...
  return (
    <Command
      ...
      className={cn(
        'h-auto overflow-visible dark:bg-input/30 dark:hover:bg-input/50',
      ...
      >
        <div className="relative flex flex-wrap items-center gap-1">
          ...
          <button
            ...
            className={cn(
              'absolute h-4 w-4 p-0 ltr:right-0 rtl:left-0',
              (hideClearAllButton ||
                disabled ||
                selected.length < 1 ||
